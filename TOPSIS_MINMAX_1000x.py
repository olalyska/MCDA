...
# translate the result to numbers(so they can correspond in visualisation with colors)
    ...
    # point < middle point -> 1
    # point = middle point -> 2 (within the indistinguishability threshold)
    # incomparable -> 0
    ...
    save_data_to_file(df, f"data/TOPSIS_MINMAX_1000x/TOP_MM_1000x_TH{threshold}_W{W_val}.csv")
